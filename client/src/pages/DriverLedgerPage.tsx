...
const DRIVER_PHOTOS = [
  ...
  'https://images.pexels.com/photos/3769021/pexels-photo-3769021.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&dpr=1',
  ...
  'https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&dpr=1',
  'https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&dpr=1',
  'https://images.pexels.com/photos/1516680/pexels-photo-1516680.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&dpr=1',
  'https://images.pexels.com/photos/3785079/pexels-photo-3785079.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&dpr=1',
  'https://images.pexels.com/photos/1300402/pexels-photo-1300402.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&dpr=1',
  'https://images.pexels.com/photos/2682452/pexels-photo-2682452.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&dpr=1',
];

const DEMO_DRIVERS: DriverLedger[] = [
  { id: 1, firstName: 'Kofi', lastName: 'Mensah', phone: '+233 24 100 2001', email: 'kofi.mensah@evergreen.logistics', photo: DRIVER_PHOTOS[0], rfidCardId: 'RFID-GH-001', guarantorName: 'Samuel Mensah', guarantorPhone: '+233 24 900 1001', academyGraduationDate: '2025-03-15', deploymentStatus: 'deployed', licenseExpiryDate: '2027-06-30', conductScore: 88, remittanceTarget: 450, remittanceActual: 420, totalTrips: 128, incidentCount: 1, isActive: true },
  { id: 2, firstName: 'Ama', lastName: 'Serwaa', phone: '+233 50 200 3002', email: 'ama.serwaa@evergreen.logistics', photo: DRIVER_PHOTOS[1], rfidCardId: 'RFID-GH-002', guarantorName: 'Kwame Serwaa', guarantorPhone: '+233 24 800 2002', academyGraduationDate: '2025-01-20', deploymentStatus: 'deployed', licenseExpiryDate: '2026-12-15', conductScore: 92, remittanceTarget: 400, remittanceActual: 440, totalTrips: 156, incidentCount: 0, isActive: true },
  { id: 3, firstName: 'Yaw', lastName: 'Boateng', phone: '+233 55 300 4003', email: 'yaw.boateng@evergreen.logistics', photo: DRIVER_PHOTOS[2], rfidCardId: 'RFID-GH-003', guarantorName: 'Adwoa Boateng', guarantorPhone: '+233 24 700 3003', academyGraduationDate: null, deploymentStatus: 'available', licenseExpiryDate: '2025-11-01', conductScore: 65, remittanceTarget: 350, remittanceActual: 280, totalTrips: 67, incidentCount: 3, isActive: true },
  { id: 4, firstName: 'Efia', lastName: 'Owusu', phone: '+233 24 400 5004', email: 'efia.owusu@evergreen.logistics', photo: DRIVER_PHOTOS[3], rfidCardId: 'RFID-GH-004', guarantorName: 'Yaw Owusu', guarantorPhone: '+233 50 600 4004', academyGraduationDate: '2025-06-10', deploymentStatus: 'deployed', licenseExpiryDate: '2027-03-22', conductScore: 78, remittanceTarget: 500, remittanceActual: 460, totalTrips: 142, incidentCount: 1, isActive: true },
  { id: 5, firstName: 'Kwame', lastName: 'Asante', phone: '+233 20 500 6005', email: 'kwame.asante@evergreen.logistics', photo: DRIVER_PHOTOS[4], rfidCardId: 'RFID-GH-005', guarantorName: 'Akua Asante', guarantorPhone: '+233 24 500 5005', academyGraduationDate: '2026-04-01', deploymentStatus: 'training', licenseExpiryDate: '2027-09-18', conductScore: 0, remittanceTarget: 0, remittanceActual: 0, totalTrips: 0, incidentCount: 0, isActive: true },
  { id: 6, firstName: 'Abena', lastName: 'Osei', phone: '+233 54 600 7006', email: 'abena.osei@evergreen.logistics', photo: DRIVER_PHOTOS[5], rfidCardId: 'RFID-GH-006', guarantorName: 'Kofi Osei', guarantorPhone: '+233 24 400 6006', academyGraduationDate: '2025-02-28', deploymentStatus: 'deployed', licenseExpiryDate: '2026-08-10', conductScore: 95, remittanceTarget: 450, remittanceActual: 500, totalTrips: 178, incidentCount: 0, isActive: true },
  { id: 7, firstName: 'Nana', lastName: 'Yaw', phone: '+233 27 700 8007', email: 'nana.yaw@evergreen.logistics', photo: DRIVER_PHOTOS[6], rfidCardId: 'RFID-GH-007', guarantorName: 'Ama Yaw', guarantorPhone: '+233 55 300 7007', academyGraduationDate: '2025-09-12', deploymentStatus: 'suspended', licenseExpiryDate: '2025-05-20', conductScore: 45, remittanceTarget: 400, remittanceActual: 250, totalTrips: 83, incidentCount: 5, isActive: false },
  { id: 8, firstName: 'Akua', lastName: 'Sarpong', phone: '+233 23 800 9008', email: 'akua.sarpong@evergreen.logistics', photo: DRIVER_PHOTOS[7], rfidCardId: 'RFID-GH-008', guarantorName: 'Yaw Sarpong', guarantorPhone: '+233 24 200 8008', academyGraduationDate: '2024-11-05', deploymentStatus: 'available', licenseExpiryDate: '2026-10-30', conductScore: 82, remittanceTarget: 300, remittanceActual: 310, totalTrips: 94, incidentCount: 0, isActive: true },
  { id: 9, firstName: 'Kwesi', lastName: 'Appiah', phone: '+233 50 900 0109', email: 'kwesi.appiah@evergreen.logistics', photo: DRIVER_PHOTOS[8], rfidCardId: 'RFID-GH-009', guarantorName: 'Efia Appiah', guarantorPhone: '+233 27 100 9009', academyGraduationDate: '2025-04-18', deploymentStatus: 'deployed', licenseExpiryDate: '2027-07-07', conductScore: 90, remittanceTarget: 500, remittanceActual: 480, totalTrips: 165, incidentCount: 1, isActive: true },
  { id: 10, firstName: 'Esi', lastName: 'Amankwah', phone: '+233 24 010 1001', email: 'esi.amankwah@evergreen.logistics', photo: DRIVER_PHOTOS[9], rfidCardId: 'RFID-GH-010', guarantorName: 'Kweku Amankwah', guarantorPhone: '+233 23 400 0100', academyGraduationDate: null, deploymentStatus: 'deployed', licenseExpiryDate: '2026-01-15', conductScore: 73, remittanceTarget: 350, remittanceActual: 320, totalTrips: 115, incidentCount: 2, isActive: true },
  { id: 11, firstName: 'Yaa', lastName: 'Achiaa', phone: '+233 55 111 2112', email: 'yaa.achiaa@evergreen.logistics', photo: DRIVER_PHOTOS[10], rfidCardId: 'RFID-GH-011', guarantorName: 'Kwame Achiaa', guarantorPhone: '+233 20 555 1111', academyGraduationDate: '2026-05-20', deploymentStatus: 'training', licenseExpiryDate: '2028-02-28', conductScore: 0, remittanceTarget: 0, remittanceActual: 0, totalTrips: 0, incidentCount: 0, isActive: true },
  { id: 12, firstName: 'Kweku', lastName: 'Andoh', phone: '+233 27 222 3223', email: 'kweku.andoh@evergreen.logistics', photo: DRIVER_PHOTOS[11], rfidCardId: 'RFID-GH-012', guarantorName: 'Ama Andoh', guarantorPhone: '+233 54 666 2222', academyGraduationDate: '2025-07-22', deploymentStatus: 'deployed', licenseExpiryDate: '2027-11-12', conductScore: 85, remittanceTarget: 400, remittanceActual: 390, totalTrips: 149, incidentCount: 1, isActive: true },
  { id: 13, firstName: 'Afia', lastName: 'Badu', phone: '+233 24 333 4334', email: 'afia.badu@evergreen.logistics', photo: DRIVER_PHOTOS[12], rfidCardId: 'RFID-GH-013', guarantorName: 'Nana Badu', guarantorPhone: '+233 50 777 3333', academyGraduationDate: null, deploymentStatus: 'available', licenseExpiryDate: '2025-09-05', conductScore: 60, remittanceTarget: 250, remittanceActual: 180, totalTrips: 45, incidentCount: 2, isActive: true },
  { id: 14, firstName: 'Kojo', lastName: 'Frimpong', phone: '+233 20 444 5445', email: 'kojo.frimpong@evergreen.logistics', photo: DRIVER_PHOTOS[13], rfidCardId: 'RFID-GH-014', guarantorName: 'Akosua Frimpong', guarantorPhone: '+233 27 888 4444', academyGraduationDate: '2025-05-30', deploymentStatus: 'deployed', licenseExpiryDate: '2028-04-19', conductScore: 97, remittanceTarget: 500, remittanceActual: 530, totalTrips: 192, incidentCount: 0, isActive: true },
  { id: 15, firstName: 'Adwoa', lastName: 'Nyarko', phone: '+233 54 555 6556', email: 'adwoa.nyarko@evergreen.logistics', photo: DRIVER_PHOTOS[14], rfidCardId: 'RFID-GH-015', guarantorName: 'Kofi Nyarko', guarantorPhone: '+233 24 999 5555', academyGraduationDate: '2025-08-14', deploymentStatus: 'suspended', licenseExpiryDate: '2026-03-10', conductScore: 55, remittanceTarget: 300, remittanceActual: 200, totalTrips: 72, incidentCount: 4, isActive: false },
];
